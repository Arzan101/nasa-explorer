...
import { apodAPI, neoAPI, marsAPI } from '../utils/api';
...
const MODULES = [
  ...
  //   icon: '◉',
  //   title: 'Mars Rovers',
  //   subtitle: 'Photos from Curiosity, Perseverance & more',
  //   color: 'mars',
  // },
  {
    path: '/neo',
    ...
    subtitle: 'Track asteroids approaching Earth',
    color: 'electric',
  },
  {
    path: '/epic',
    ...
    subtitle: 'DSCOVR EPIC satellite imagery',
    color: 'green',
  },
  {
    path: '/search',
    icon: '◇',
    title: 'Image Library',
    subtitle: 'Search NASA\'s vast media archive',
    color: 'ion',
  },
];
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.heroTitle}>
            Explore the
            <br />
            <span className={styles.heroGradient}>Universe</span>
          </h1>
          <p className={styles.heroSub}>
            Real-time data from NASA's APIs asteroids, Mars rovers, Earth imagery, and beyond.
          </p>
          ...
          {loading ? (
            ...
            <div className={styles.apodPreview}>
              {apod.media_type === 'image' ? (
                ...
                <div className={styles.apodVideo}>
                  <span>🎬</span>
                  <span>Video: {apod.title}</span>
                </div>
              )}
      ...
      <section className={styles.statsBar}>
        <div className={styles.statItem}>
          <span className={styles.statNum}>{neoCount ?? '—'}</span>
          <span className={styles.statDesc}>Asteroids tracked this week</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.statItem}>
          <span className={styles.statNum}>4</span>
          <span className={styles.statDesc}>Active Mars rovers</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.statItem}>
          <span className={styles.statNum}>∞</span>
          <span className={styles.statDesc}>Images in library</span>
        </div>
        <div className={styles.statDivider} />
        <div className={styles.statItem}>
          <span className={styles.statNum}>Live</span>
          <span className={styles.statDesc}>NASA API data</span>
        </div>
      </section>
